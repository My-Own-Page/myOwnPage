...
const textToImageMap = {
  "오늘은 행복한 하루가 될 거예요!": "fortune/image/taroMain.jpg",
  "잘하고 있는 당신을 칭찬해요!": "fortune/image/taroMain.jpg",
  "뭐든지 할 수 있어요!": "fortune/image/taroMain.jpg",
  "긍정적인 생각으로 시작해보세요!": "fortune/image/taroMain.jpg",
  "좋은 일이 곧 찾아올 거예요!": "fortune/image/taroMain.jpg",
  "운동을 마음만 먹고 안하면 안돼요!": "fortune/image/taroMain.jpg",
  "어떤 일에든 셈을 정확히 해야 해요.": "fortune/image/taroMain.jpg",
  "마음이 무거운 일이 생기니 속상해요.": "fortune/image/taroMain.jpg",
  "안 된다고 포기하는 순간에 될 거예요.": "fortune/image/taroMain.jpg",
  "지겹다고 포기하지 말고 끈기를 가져요.": "fortune/image/taroMain.jpg",
  "아무도 내 얘기를 믿어주지 않겠어요.": "fortune/image/taroMain.jpg",
  "세상에 공짜는 없는 법이니 다시 생각해요.": "fortune/image/taroMain.jpg",
  "내 짜증을 남에게 전가하지 마세요.": "fortune/image/taroMain.jpg",
  "나를 치장하려고 낭비가 심하면 안돼요.": "fortune/image/taroMain.jpg",
  "남들이 싫어한다고 나까지 그러면 안 돼요.": "fortune/image/taroMain.jpg"
};
...
const EggImage = document.querySelector('.container1 .section .egg .egg1');
...
EggBtnClick.addEventListener('click',()=>{
  ...
  //스코어가 100이 되면 사진이 변경 되도록 구현
  if(eggClickCount === 1){
    EggText.textContent = '이제 400번 남았습니다!';
    EggImage.style.backgroundImage ='./image/Eggbreak.png';
  }if (eggClickCount === 2) {
    EggImage.style.backgroundImage = './image/AllEggbreak.png';
...
EggMain.addEventListener('click',()=>{
  ...
  EggImage.style.backgroundImage = 'none';
...
Egg.addEventListener('click', () => {
  ...
  EggImage.style.backgroundImage = './image/Egg.png';
});